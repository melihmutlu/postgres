...
# Set disable_on_error to true to avoid multiple failures.
$node_subscriber->safe_psql('postgres',
	"ALTER SUBSCRIPTION tsub SET (disable_on_error = true)");
...
# Enable the subscription since it is disabled due to previous error
$node_subscriber->safe_psql('postgres', "ALTER SUBSCRIPTION tsub ENABLE");
